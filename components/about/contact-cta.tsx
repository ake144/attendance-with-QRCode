  ...
  return (
    <section className="bg-gray-100 text-gray-900 py-16">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold mb-4 text-[#F09F2C] ">Join Our Community</h2>
        ...
        <Button asChild size="lg"  className="text-[#F09F2C] border-[#F09F2C] hover:bg-[#F09F2C] hover:text-white"
  variant="outline">
