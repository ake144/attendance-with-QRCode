  ...
  return (
    <section id="events" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-[#379AFE] mb-12 text-center">
          Upcoming Events
        </h2>
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {events.map((event, index) => (
            <div
              key={index}
              className="bg-white border border-[#379AFE] rounded-lg shadow-md overflow-hidden"
            >
              <Image
                src={event.image}
                alt={event.title}
              ...
              <div className="p-6">
                ...
                <Button
                  variant="outline"
                  className="text-[#379AFE] border-[#379AFE] hover:bg-[#379AFE] hover:text-white"
                >
                  Learn More
                </Button>
              </div>
